window.blake3Js = (function (t) {
  ...
  function (t, n, e) {
    ...
    function r(t) {
      return (
        t > 4294967295 && (t -= 4294967296),
        t.toString(2).padStart(32, "0")
      );
    }
    function i(t) {
      return parseInt(t, 2);
  ...
  function (t, n, e) {
    ...
    function u(t, n) {
      ...
      return (
        ...
        (e = i(e, 1, 5, 9, 13, n[2], n[3])),
        (e = i(e, 2, 6, 10, 14, n[4], n[5])),
        (e = i(e, 3, 7, 11, 15, n[6], n[7])),
        (e = i(e, 0, 5, 10, 15, n[8], n[9])),
        (e = i(e, 1, 6, 11, 12, n[10], n[11])),
        (e = i(e, 2, 7, 8, 13, n[12], n[13])),
        (e = i(e, 3, 4, 9, 14, n[14], n[15]))
      );
    }
    function o(t, n) {
                ...
                for (var n = 0, e = []; e.length < t; ) {
                  ...
                  try {
                    for (
                      ...
                      e = [].concat(
                        o(e),
                        o((0, u.little_endian_bytes_from_words)([h])),
                      );
                    }
                  } catch (d) {
                    ((l = !0), (c = d));
  ...
  function (t, n, e) {
    ...
    var l = (0, r.intu32)(64),
      ...
      d = (0, r.intu32)(64);
    function v(t, n, e, i) {
      var o = [].concat(s(t.slice(0, 8)), s(n.slice(0, 8)));
      return new u.default(e, o, (0, r.intu64)(0), l, (0, r.or)(c, i));
    }
    function _(t) {
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            ...
            value: function (t) {
              return (
                "string" == typeof t ? (t = _(t)) : new Uint8Array(t),
                new u((0, r.words_from_little_endian_bytes)(t), $)
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              return new u((0, r.words_from_little_endian_bytes)(e), d);
            },
          },
        ]),
        (n = [
          {
            key: "pushStack",
            value: function (t) {
              ((this.cv_stack[this.cv_stack_len] = t),
                (this.cv_stack_len += 1));
            },
          },
          {
            ...
            value: function () {
              return (
                (this.cv_stack_len -= 1),
                this.cv_stack[this.cv_stack_len]
              );
            },
          },
          {
            ...
            value: function (t, n) {
              for (var e, i, u, o; (0, r.u64int)(n) % 2 == 0; )
                ((e = this.popStack()),
                  (i = t),
                  (t = v(
                    e,
          ...
          },
          {
            ...
            value: function (t) {
              for (
                t = "string" == typeof t ? _(t) : new Uint8Array(t);
                t.length;
              ) {
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: "start_flag",
              value: function () {
                return 0 === this.blocks_compressed ? s : (0, r.intu32)(0);
              },
            },
            {
              key: "update",
            ...
            },
            {
              ...
              value: function () {
                ...
                return new u.default(
                  ...
                  (0, r.or)((0, r.or)(this.flags, this.start_flag()), l),
                );
              },
            },
          ]),
