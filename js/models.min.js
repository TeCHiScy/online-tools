  ...
  var r,
    n = [
      ...
      },
      {
        ...
        refin: !1,
        refout: !1,
        xorout: [255, 4294967295],
        name: "CRC-40/GSM",
      },
      {
        width: 64,
        poly: [1123082731, 2850698899],
        init: [0, 0],
        refin: !1,
        refout: !1,
        xorout: [0, 0],
      ...
      },
      {
        width: 64,
        poly: [0, 27],
        init: [4294967295, 4294967295],
        refin: !0,
        refout: !0,
        xorout: [4294967295, 4294967295],
        name: "CRC-64/GO-ISO",
      },
      {
        width: 64,
        poly: [631014603, 2789368649],
        init: [4294967295, 4294967295],
        refin: !0,
        refout: !0,
        xorout: [0, 0],
    ...
    i = (o = "object" == typeof window) ? window : {},
    o = !(o = i.JS_CRC_NO_WINDOW ? !1 : o) && "object" == typeof self,
    o =
      (!i.JS_CRC_NO_NODE_JS &&
      ...
      process.versions.node
        ? (i = global)
        : o && (i = self),
      !i.JS_CRC_NO_COMMON_JS && "object" == typeof module && module.exports),
    t = "function" == typeof define && define.amd;
  function C(i) {
    for (var o = 0; o < n.length; ++o) {
      var t = n[o],
        C = t.name.replace(/[-/]/g, "_").toLocaleLowerCase();
      if (((i[C] = r(n[o])), t.alias))
        for (var e = 0; e < t.alias.length; ++e)
          i[t.alias[e].replace(/[-/]/g, "_").toLocaleLowerCase()] = i[C];
    }
  }
  var e = {};
  if (o) ((r = require("./crc.js").createModel), C(e), (module.exports = e));
  else {
    for (var f in ((r = i.createModel), C(e), e)) i[f] = e[f];
    t &&
      define(function () {
        return e;
      });
