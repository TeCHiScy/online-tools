...
!(function (e, t) {
      ...
      "undefined" != typeof globalThis
        ...
        : "undefined" != typeof self
          ...
          : "undefined" != typeof window
            ? window
            : global,
    r = null !== (t = n.Buffer) && void 0 !== t ? t : null,
    i = n.TextEncoder ? new n.TextEncoder() : null,
    f =
      null !== r
        ? (e) => {
            if ("string" == typeof e) {
              const t = r.from(e, "utf8");
        ...
        : (e) => {
            if ("string" == typeof e) return i.encode(e);
            if (ArrayBuffer.isView(e))
              return new Uint8Array(e.buffer, e.byteOffset, e.byteLength);
            throw new Error("Invalid data type!");
          },
  ...
  function a(e, t) {
    ...
    e.update(i);
    const s = {
      init: () => (e.init(), e.update(i), s),
      update: (t) => (e.update(t), s),
      digest: (t) => {
        const n = e.digest("binary");
        return (e.init(), e.update(o), e.update(n), e.digest(t));
      },
      save: () => {
