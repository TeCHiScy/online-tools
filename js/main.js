!(function (t, e, a, o) {
  ...
  function l(o, n) {
    ...
    return (
      o ||
        ...
        (r.prop("checked", !0),
        i.each(function () {
          var e = localStorage.getItem(p + "_" + t(this).data("remember"));
          e &&
            ("SELECT" === this.tagName
      ...
      r.change(function () {
        r.prop("checked")
          ...
          : ((c = !1),
            ...
            i.each(function () {
              localStorage.removeItem(p + "_" + t(this).data("remember"));
            }));
      }),
      i.on("input", function () {
        if (c) {
          var e = p + "_" + t(this).data("remember");
          "checkbox" === this.type
            ? t(this).prop("checked")
      ...
      i.length || r.closest(".option-block").hide(),
      c
    );
  }
  function s() {
  ...
  function h() {
    ...
    var i = localStorage.getItem("NO_SWAPPED");
    return (localStorage.removeItem("NO_SWAPPED"), a.length && !i);
  }
  function d() {
    var e = t("#share-link");
    if (e.length) {
      ...
      var o = "";
      (a.length &&
        (o = location.origin + location.pathname + "?" + a.join("&")),
        e.val(o));
    }
  }
  ((e.ot = e.ot || {}),
          ...
          return function (e) {
            for (var a = [], r = 0; r < n.length; ++r) {
              ...
              if ("encoding" === i.type) {
                ...
                var l = i.element.val();
                ("number" === i.element.attr("type")
                  ? (l = parseFloat(l))
                  : "checkbox" === i.element.attr("type") &&
                    (l = i.element.prop("checked")),
                  a.push(l));
              }
            }
            return (a.splice(o, 0, e), t.apply(this, a));
          };
        },
        i = r(e);
      return (e.update && (i.update = r(e.update)), i);
    }));
  ...
  e.swap = function (e, a) {
    ...
    for (var o = {}, n = 0; n < a.length; ++n) {
      var r = a[n],
        i = t(r[0]);
      o[r[1]] = r[2] ? (i.prop("checked") ? "1" : "") : i.val();
    }
  ...
  t(a).ready(function () {
    ...
    ((e.methodLoad = function () {
      ++C < waitLoadCount ||
        (t(e).trigger("methodLoad"), (o || n || (i && k) || S) && g());
    }),
      (ot.getQuery = s),
