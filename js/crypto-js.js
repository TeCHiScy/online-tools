!(function () {
  ...
  function i(r, t, e, n, i, s, a, u, c, l, f) {
    if ("custom" === n) {
      if (((c = o(c)), c.sigBytes !== r / 8))
        throw new Error("Key must be " + r + " bits.");
      if ("ECB" !== e && ((l = o(l)), 8 * l.sigBytes !== t))
      ...
      ((c = _.enc.Hex.parse(w.substr(0, r / 4))),
        (l = _.enc.Hex.parse(w.substr(r / 4))));
    }
    return [c, l];
  }
  function s(r, t, e, n, o, s, a, u, c, l, f, d, p) {
    var g = w[e] ? z[d] : z.NoPadding,
      y = i(r, t, e, n, o, s, a, u, c, l, f);
  ...
  function c(t, i, u, c, l, f, d, p, w, g, h, v, E, B, D, m, b) {
    var A = c instanceof y;
    c = n(c);
    var S = c.length;
    if ((A && (ot.setFilename(t), (S = ot.getFile().size)), !a(f, d, S, u)))
      throw new Error("Message must be multipler of " + u + " bits.");
    if (("custom" === p && (D = "nosalt"), "random" === D)) m = F.random(8);
    else if ("nosalt" === D) m = null;
    else if (((m = o(m)), 8 !== m.sigBytes))
      throw new Error("Salt must be 64 bits.");
    var C = s(l, u, f, p, w, g, h, v, E, B, m, d, b),
      k = i.createEncryptor(C[0], C[1]),
      _ = new (A ? ot.DownloadBuilder : r)();
    m && _.push(e(F.create([1398893684, 1701076831]).concat(m)));
    var $ = {
      update: function (r) {
  ...
  function f(n, i, u, c, l, f, d, w, g, h, v, E, B, D) {
  ...
  ((window.aes = {}),
    ...
    (aes.encrypt = l(function (r, t, e, n, o, i, s, a, u, l, f, d, p) {
      return c("aes.dat", x.AES, 128, r, t, e, n, o, i, s, a, u, l, f, d, p);
    })),
    (des.encrypt = l(function (r, t, e, n, o, i, s, a, u, l, f, d) {
      return c("des.dat", x.DES, 64, r, 64, t, e, n, o, i, s, a, u, l, f, d);
    })),
    (tripleDes.encrypt = l(function (r, t, e, n, o, i, s, a, u, l, f, d, p) {
      return c(
        "3des.dat",
        x.TripleDES,
        64,
    ...
    (rc4.encrypt = l(function (r, t, e, n, o, i, s, a, l, f, d) {
      return (
        (l = u(e, a, l)),
        c(
          "rc4.dat",
    ...
    (aes.decrypt = l(function (r, t, e, n, o, i, s, a, u, c, l) {
      return f(x.AES, 128, r, t, e, n, o, i, s, a, u, c, l);
    })),
    (des.decrypt = l(function (r, t, e, n, o, i, s, a, u, c) {
      return f(x.DES, 64, r, 64, t, e, n, o, i, s, a, u, c);
    })),
    (tripleDes.decrypt = l(function (r, t, e, n, o, i, s, a, u, c, l) {
      return f(x.TripleDES, 64, r, t, e, n, o, i, s, a, u, c, l);
    })),
    (rc4.decrypt = l(function (r, t, e, n, o, i, s, a, c) {
      return (
        (c = u(e, a, c)),
        f(x.RC4Drop, 0, r, c, "ECB", null, e, n, o, i, s, a, null, t)
      );
    })));
  var h = $("#mode"),
    v = $("#iv-block"),
